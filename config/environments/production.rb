...
Rails.application.configure do
  ...
  config.action_mailer.default_options = {from: 'guessgames@puhoff.com', reply_to: 'guessgames@puhoff.com'}
  config.action_mailer.default_url_options = { :host => 'http://guessgames.puhoff.com' }
